...
public class BossLootHandler {
    ...
    public static void onBossMobDrops(LivingDropsEvent event) {
        ...
        float lootMultiplier = isLord ? 1.0f : 0.25f; // Non-lord bosses get greatly reduced loot.
        ...
        // We'll scale down each loot stack from dungeon loot by the multiplier.
        ...
        // Reward F: If Loot Bags mod is installed and the boss is a lord, drop legendary loot bag.
        // For non-lord bosses, we skip this reward.
    ...
    private static ItemStack generateElementalWeapon(int tier, Random rand) {
        ...
        // Add extra enchantments randomly (up to 2 extra).
